...
EVENT_ID=ag9zfmRldmZlc3RnbG9iYWxyDQsSBUV2ZW50GNKsBgw
...
wget -O../android/res/raw/sandbox.json --no-check-certificate http://www.devfest.info/json/event/$EVENT_ID/sponsors
